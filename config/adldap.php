            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'ldap.project-immobilien.com')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'OU=Users,OU=Project,DC=prj-nue-mail,DC=com'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'prj-nue-mail\ldap'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'B51RmgAfLAZnqVymlPWs'),
